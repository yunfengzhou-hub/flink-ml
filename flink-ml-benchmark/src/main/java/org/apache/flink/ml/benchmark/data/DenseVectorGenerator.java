...
/** Class that generates a table containing dense vectors. */
public class DenseVectorGenerator
        implements DataGenerator<DenseVectorGenerator>,
                DenseVectorGeneratorParams<DenseVectorGenerator> {
    ...
    public Table[] getData(StreamTableEnvironment tEnv) {
        ...
        if (getOutputCols() != null) {
            dataTable = dataTable.as(getOutputCols()[0]);
        }
