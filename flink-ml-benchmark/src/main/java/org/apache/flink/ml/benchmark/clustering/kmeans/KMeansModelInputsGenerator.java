 ...
 */
public class KMeansModelInputsGenerator
        implements DataGenerator<KMeansModelInputsGenerator>,
                GeneratorParams<KMeansModelInputsGenerator>,
                KMeansModelParams<KMeansModelInputsGenerator> {
    private final Map<Param<?>, Object> paramMap = new HashMap<>();

    public KMeansModelInputsGenerator() {
