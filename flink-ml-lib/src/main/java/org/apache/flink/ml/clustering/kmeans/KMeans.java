...
import org.apache.flink.ml.linalg.typeinfo.DenseVectorWithNormSerializer;
...
public class KMeans implements Estimator<KMeans, KMeansModel>, KMeansParams<KMeans> {
    ...
    private static class CentroidsUpdateAccumulator
        ...
        private ListStateWithCache<DenseVectorWithNorm> points;
        ...
        public void initializeState(StateInitializationContext context) throws Exception {
            ...
            points =
                    new ListStateWithCache<>(
                            new DenseVectorWithNormSerializer(),
                            getContainingTask(),
                            getRuntimeContext(),
                            context,
        ...
        public void processElement1(StreamRecord<DenseVector> streamRecord) throws Exception {
            points.add(new DenseVectorWithNorm(streamRecord.getValue()));
        }
        ...
        public void onEpochWatermarkIncremented(
            ...
            DenseVectorWithNorm[] centroidsWithNorm =
                    new DenseVectorWithNorm[centroidValues.length];
            for (int i = 0; i < centroidsWithNorm.length; i++) {
                centroidsWithNorm[i] = new DenseVectorWithNorm(centroidValues[i]);
            }
            ...
            for (DenseVectorWithNorm point : points.get()) {
